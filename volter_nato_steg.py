...
def _translate_text(text: str, lexicon: Dict[str, str]) -> str:
...
def encode_operator_message(message: str, passphrase: str) -> str:
    if not isinstance(message, str):
        raise SteganographyError("Message must be a string.")
    translated = _translate_text(message, OPERATOR_LEXICON)
    return encrypt_to_nato(translated.encode("utf-8"), passphrase)


def decode_operator_message(nato_text: str, passphrase: str) -> str:
